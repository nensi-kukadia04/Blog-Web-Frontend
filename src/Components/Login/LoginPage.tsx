...
import { FaUserAlt, FaLock, FaEye, FaEyeSlash, FaFeatherAlt, FaPenNib } from "react-icons/fa";
  ...
  return (
    <div className="h-screen min-h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-slate-50 via-blue-100 to-indigo-200 overflow-hidden relative">
      ...
      >
        ...
        >
          Your Stories <br /> Deserve to Shine ✨
        </motion.h2>
        ...
        >
          Join <span className="font-semibold text-white">Blogify</span> and turn your thoughts into stories that connect and inspire.
          A platform for creators, writers, and dreamers.
        </motion.p>
      ...
      >
        {/* ✨ Floating fairy circles (soft glowing orbs) */}
        <motion.div
        ...
        <div className="relative w-full max-w-md bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-10 z-10 overflow-hidden">
          ...
          >
            ...
            <p className="text-slate-600">Sign in to continue your creative journey</p>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm text-slate-600">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input type="checkbox" className="text-indigo-500 rounded focus:ring-indigo-500" />
